...
export const LEGACY_WORKER_REGISTRY: LegacyWorkerDefinition[] = [
  { id: "scanner", label: "Scanner Worker", tier: "CRITICAL", queueName: "scanner", profitImpact: "direct" },
  { id: "pump-early-catcher", label: "Pump Early Catcher", tier: "CRITICAL", profitImpact: "direct" },
  { id: "discovery", label: "Discovery Engine", tier: "CRITICAL", queueName: "discovery", profitImpact: "direct" },
  { id: "execution-management", label: "Execution Management", tier: "CRITICAL", queueName: "execution-management", profitImpact: "direct" },
  { id: "execution-engine-v2", label: "Execution Engine V2", tier: "CRITICAL", queueName: "execution-engine-v2", profitImpact: "direct" },
  { id: "execution-safety", label: "Execution Safety", tier: "CRITICAL", queueName: "execution-safety", profitImpact: "direct" },
  { id: "decision-replay", label: "Decision Replay", tier: "SUPPORTING", queueName: "decision-replay", profitImpact: "indirect" },
  { id: "market-intelligence", label: "Market Intelligence", tier: "SUPPORTING", queueName: "market-intelligence", profitImpact: "indirect" },
  { id: "decision-engine", label: "Decision Engine Workers", tier: "SUPPORTING", queueName: "decision-engine", profitImpact: "indirect" },
  { id: "shadow-validation", label: "Shadow Validation", tier: "SUPPORTING", queueName: "shadow-validation", profitImpact: "indirect" },
  { id: "exchange-simulator", label: "Exchange Simulator", tier: "SUPPORTING", queueName: "exchange-simulator", profitImpact: "indirect" },
  { id: "learning-engine", label: "Learning Engine", tier: "SUPPORTING", queueName: "learning-engine", profitImpact: "indirect" },
  { id: "learning-platform", label: "Learning Platform", tier: "SUPPORTING", queueName: "learning-platform", profitImpact: "indirect" },
  { id: "quant-research", label: "Quant Research", tier: "SUPPORTING", queueName: "quant-research", profitImpact: "indirect" },
  { id: "paper-validation", label: "Paper Validation", tier: "SUPPORTING", queueName: "paper-validation", profitImpact: "indirect" },
  { id: "live-trading", label: "Live Trading Production", tier: "CRITICAL", queueName: "live-trading", profitImpact: "direct" },
  { id: "entry-timing", label: "Entry Timing", tier: "SUPPORTING", queueName: "entry-timing", profitImpact: "indirect" },
  { id: "exit-timing", label: "Exit Timing", tier: "SUPPORTING", queueName: "exit-timing", profitImpact: "indirect" },
  { id: "strategy-selector", label: "Strategy Selector", tier: "SUPPORTING", queueName: "strategy-selector", profitImpact: "indirect" },
  { id: "performance-optimizer", label: "Performance Optimizer", tier: "SUPPORTING", queueName: "performance-optimizer", profitImpact: "indirect" },
  { id: "aoc", label: "Autonomous Operations Center", tier: "SUPPORTING", queueName: "aoc", profitImpact: "indirect" },
  { id: "ai-governance", label: "AI Governance", tier: "OBSERVE_ONLY", queueName: "ai-governance", profitImpact: "none" },
  { id: "news-intelligence", label: "News Intelligence", tier: "OBSERVE_ONLY", queueName: "news-intelligence", profitImpact: "none" },
  { id: "whale-intelligence", label: "Whale Intelligence", tier: "OBSERVE_ONLY", queueName: "whale-intelligence", profitImpact: "none" },
  { id: "onchain-intelligence", label: "OnChain Intelligence", tier: "OBSERVE_ONLY", queueName: "onchain-intelligence", profitImpact: "none" },
  { id: "engineering-intelligence", label: "Engineering Intelligence", tier: "OBSERVE_ONLY", queueName: "engineering-intelligence", profitImpact: "none" },
  { id: "meta-intelligence", label: "Meta Intelligence", tier: "OBSERVE_ONLY", queueName: "meta-intelligence", profitImpact: "none" },
  { id: "intelligence-fusion", label: "Intelligence Fusion", tier: "OBSERVE_ONLY", queueName: "intelligence-fusion", profitImpact: "none" },
  { id: "exchange-abstraction", label: "Exchange Abstraction", tier: "OBSERVE_ONLY", queueName: "exchange-abstraction", profitImpact: "none" },
  { id: "event-platform", label: "Event Platform", tier: "OBSERVE_ONLY", queueName: "event-platform", profitImpact: "none" },
];
